...
<body>
    ...
    <div class="secundario-Recepcion">
        <h1 class="recepcion">RECEPCIÓN</h1>
        <img class="salon" src="/Imagenes/copaListo.gif" alt="">
        <h1 class="hora">21:00 PM</h1>
        <h1 class="salonNombre">Salón los olivos</h1>
        <h1 class="direccion">C. Francisco I. Madero 20, Coacalco, 55700 San Francisco Coacalco, Méx.</h1>
        <div id="map-recepcion"></div>
        <a href="https://www.google.com/maps/place/Sal%C3%B3n+Los+Olivos/@19.6310019,-99.1055994,17z/data=!3m1!4b1!4m6!3m5!1s0x85d1f3003843390b:0xb2de8e298f26083!8m2!3d19.6309969!4d-99.1030245!16s%2Fg%2F11y3780kp9?entry=ttu" target="_blank">
            <button class="btn">
                <div class="wrapper">
                    <p class="text">COMO LLEGAR</p>
                    <div class="flower flower1">
    ...
    <div class="vestimenta">
        <h1 class="recepcion">CÓDIGO DE VESTIMENTA</h1>
        <h2 class="etiqueta">ETIQUETA</h2>
        <img class="hombre" src="/Imagenes/Hombre.jpg" alt="">
        <img class="mujer" src="/Imagenes/Mujer.jpg" alt="">
        <h1 class="reserva">Se reserva el tono negro y rosado para la festejada .</h1>
    </div>
    ...
    <div class="esperamos">
        <h1 class="tituloEspera">¡TE ESPERAMOS!</h1>
        <h2 class="asistencia">Confirmar tu asistencia enviando mensaje al siguiente chat de whatsapp antes del 10 de octubre del 2024.</h2>
